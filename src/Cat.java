...
public class Cat {
	...
	private static final int EYE_SEPARATION = HEAD_DIMENSION/9;
	// pick eye dimensions
	...
	private static final int MOUTH_X = HEAD_DIMENSION/5 * 9;
	private static final int MOUTH_Y = HEAD_DIMENSION/5 * 9;
